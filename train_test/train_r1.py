...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="RansErica/gatechinfo1")
    ...
    Assume that you are an academic counseling assistant at Georgia Institute of Technology ECE. Please respond to the following questions from students:
    ...
    merged_model.save_pretrained("merged_model_1",safe_serialization=True)
    tokenizer.save_pretrained("merged_model_1")
